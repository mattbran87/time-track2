$(document).ready(function($) {
  ...
  $(document.body).on('click', '#addTaskItem', function() {
  ...
  $(document.body).on('click', '.task-name', function() {
    ...
    $('.modal-footer').append('<button type="button" class="btn btn-danger" id="deleteTask">Delete</button><button type="button" class="btn btn-success" id="updateTask">Update</button>');

    startTimeButton();

    endTimeButton();

    formSubmitUpdateTask($(this)[0].dataset, function() {
      pageLoadData()
